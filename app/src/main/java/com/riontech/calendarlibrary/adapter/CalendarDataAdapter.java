...
import com.riontech.calendarlibrary.dao.SectionDataViewHolder;
import com.riontech.calendarlibrary.dao.SectionTitleViewHolder;
...
public class CalendarDataAdapter extends RecyclerView
    ...
    public CalendarDataAdapter(ArrayList<Object> items, Context context) {
        this.mItems = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case SECTION:
                View viewSection = inflater.inflate(R.layout.row_data_header_calendar, viewGroup, false);
                viewHolder = new SectionTitleViewHolder(viewSection);
                break;

            case DATA:
                View viewData = inflater.inflate(R.layout.row_data_desc_calendar, viewGroup, false);
